...
//            System.out.println(Objects.requireNonNull(response));
            ...
            ResponseObject response = restTemplate.patchForObject(
                    "http://demo.codingnomads.co:8080/tasks_api/users/" + String.valueOf(user.getId()),
                    user,
                    ResponseObject.class);
            ...
            ResponseEntity<ResponseObject> entityResponse = restTemplate.exchange(
                    "http://demo.codingnomads.co:8080/tasks_api/users/" + String.valueOf(user.getId()),
                    HttpMethod.PATCH,
                    httpUser,
                    ResponseObject.class);
